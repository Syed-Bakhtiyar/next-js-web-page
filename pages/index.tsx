  ...
  return (
    <div>
      ...
      <main>
        ...
        {/* <FormControl variant="outlined" className={styles.mainFormInputFields}>
                      <InputLabel className={styles.mainFormInputFields} id="demo-simple-select-label">Age</InputLabel>
                      <Select
                        className={styles.mainFormInputFields}
                        labelId="demo-simple-select-label"
                        id="demo-simple-select"
                      >
